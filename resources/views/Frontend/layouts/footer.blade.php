                    ...
                    <div class="row justify-content-center">
                                ...
                                <ul class="list-unstyled ps-0 mb-0">
                                    ...
                                    <li>
                                        ...
                                        <a class="text-decoration-none"
                                            href="mailto:abdallhelzayat194@gmail.com">abdallhelzayat194@gmail.com</a>
                                    </li>
                                    <li>
                                        <strong>Phone:</strong>
                                        <a class="text-decoration-none" href="tel:55472543526">+201212484233</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6 col-md-4">
                            <div class="single-footer-info">
                                ...
                                <ul class="list-unstyled ps-0 mb-0">
                                    <li>
                                        <a class="text-decoration-none" href="{{ route('about') }}">About Us</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a class="text-decoration-none" href="{{ route('blogs') }}">Our Blog</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6 col-md-4">
                            <div class="single-footer-info">
                                ...
                                <ul class="list-unstyled ps-0 mb-0">
                                    ...
                                    <li>
                                        <a class="text-decoration-none" href="{{ route('policy') }}">Privacy Policy</a>
                                    </li>
                                    <li>
