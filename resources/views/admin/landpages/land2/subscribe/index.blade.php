    ...
    <div class="main-content">
        <div class="section">
            <div class="section-header">
                <h1>Subscribe Landing Page2</h1>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a @class(['btn-primary btn']) href="{{ route('admin.subscribe-2.create') }}">Create New</a>
                        </div>
                        <div class="card-body">
                                        ...
                                        @foreach ($subscribes as $key => $subscribe)
                                            <tr>
                                                ...
                                                <td class="d-flex align-items-center gap-5">
                                                    <a href="{{ route('admin.subscribe-2.destroy', $subscribe->id) }}"
                                                        class="btn btn-danger btn-sm mr-2 delete-item">Delete</a>
                                                    <a href="{{ route('admin.subscribe-2.edit', $subscribe->id) }}"
