    ...
    <div class="main-content">
        <div class="section">
            <div class="section-header">
                <h1>Information Landing Page 3</h1>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a @class(['btn-primary btn']) href="{{ route('admin.info-3.create') }}">Create New</a>
                        </div>
                        <div class="card-body">
                                        ...
                                        @foreach ($informaitions as $key => $info)
                                            <tr>
                                                ...
                                                <td class="d-flex align-items-center gap-5">
                                                    <a href="{{ route('admin.info-3.destroy', $info->id) }}"
                                                        class="btn btn-danger btn-sm mr-2 delete-item">Delete</a>
                                                    <a href="{{ route('admin.info-3.edit', $info->id) }}"
