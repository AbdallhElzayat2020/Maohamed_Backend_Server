...
@section('title_dashboard', 'Information LandOne')
@section('content')
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1> Information LandOne</h1>
            </div>

            <div class="card card-primary">
                <div class="card-header">
                    <h4>Information LandOne</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.info-1.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ old('price') }}" required name="price" class="form-control">
                            @error('price')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
