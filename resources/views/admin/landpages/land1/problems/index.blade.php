...
@section('title_dashboard', 'Problems Page')
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a @class(['btn-primary btn']) href="{{ route('admin.problems.create') }}">Create New</a>
                        </div>
                        <div class="card-body">
                                        ...
                                        @foreach ($problems as $key => $problem)
                                            <tr>
                                                ...
                                                <td class="d-flex align-items-center gap-5">
                                                    <a href="{{ route('admin.problems.destroy', $problem->id) }}"
